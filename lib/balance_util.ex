defmodule Teiserver.Battle.BalanceUtil do
  ...
  @spec replace_team_group_at_index(team_map(), T.team_id(), non_neg_integer(), expanded_group()) ::
          team_map()
  ...
  @spec make_group_combinations([expanded_group()], non_neg_integer(), boolean()) ::
          {[[{expanded_group(), non_neg_integer()}]], map()}
